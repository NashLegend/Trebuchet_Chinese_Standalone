...
public class AllAppsGridAdapter extends RecyclerView.Adapter<AllAppsGridAdapter.ViewHolder> {
    ...
    public void setGridTheme(int gridTheme) {
        ...
        mAllAppsTextColor = mGridTheme == AllAppsContainerView.GRID_THEME_DARK ?
                mLauncher.getResources().getColor(R.color.quantum_panel_text_color_dark) :
                mLauncher.getResources().getColor(R.color.quantum_panel_text_color);
        ...
        mPredictedAppsDividerPaint.setColor(mLauncher.getResources().getColor(mPredictedAppsDividerColorId));
    }
