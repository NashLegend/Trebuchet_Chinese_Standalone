    ...
    */
    ...
    public void onDrop(final DragObject d) {
        ...
        if (d.dragSource != this) {
            ...
            if (d.dragView.hasDrawn()) {
                final ItemInfo info = (ItemInfo) cell.getTag();
                boolean isWidget = info.itemType == Favorites.ITEM_TYPE_APPWIDGET
    ...
    private void onDropExternal(final int[] touchXY, final Object dragInfo,
        ...
        if (info instanceof PendingAddItemInfo) {
            ...
            if (pendingInfo.itemType == Favorites.ITEM_TYPE_SHORTCUT) {
            ...
            boolean isWidget = pendingInfo.itemType == Favorites.ITEM_TYPE_APPWIDGET
                    || pendingInfo.itemType == Favorites.ITEM_TYPE_CUSTOM_APPWIDGET;
